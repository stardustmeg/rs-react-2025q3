...
const NotFoundPage: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center space-y-6 p-6 text-center">
      ...
      <h1 className="text-3xl font-bold text-custom-dark-night">404 - Page Not Found</h1>

      <p className="max-w-md text-lg text-shadow-custom-dark-night">It is not the page you are looking for.</p>
